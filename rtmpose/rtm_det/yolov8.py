...
from rtmpose.base import BaseTool
from rtmpose.rtm_det.post_processing import multiclass_nmsv2
...
if __name__ == '__main__':
    ...
    video_path = r"D:\篮球\192.168.1.100_01_20250211171619541.mp4"
    ...
    while cap.isOpened():
        ...
        if not success:
            continue
        ### 椅子56，人0，
        boxes,scores,cls_inds = model(frame, 0.3, [0,32])
        print(cls_inds)
